...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <hr>
        <table id="mealsTable" class="table table-striped">
            <thead>
            <tr>
                ...
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="<spring:message code="meal.description"/>"
                               ...
                               id="description" size=40 name="description" required>
                    </div>

                    <div class="form-group">
                        <label for="calories" class="col-form-label"><spring:message code="meal.calories"/></label>
                        <input type="number" class="form-control" placeholder="1000" value="${meal.calories}"
                               id="calories"
